...
[Возможности](#возможности) · [Два макета](#два-макета) · [Геопривязка](#геопривязка-города-и-контуры) · [Установка](#быстрый-старт) · [Настройка](#настройка-presentation-mode) · [Документация](#документация)
...
cd SatDump
chmod +x scripts/astra/*.sh scripts/*.sh
```

### 2. Проверка Astra Linux
